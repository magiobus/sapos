  ...
  def live_search
    ...
    respond_with do |format|
      ...
      format.xls do
        ...
        column_order = ["Matricula", "Nombre", "Apellidos", "Estado","Campus", "Ciudad_Nac", "Estado_Nac", "Pais_Nac", "Programa", "Inicio", "Fin", "Asesor", "Coasesor", "Tesis", "Sinodal1", "Sinodal2", "Sinodal3", "Sinodal4", "Sinodal5"]
